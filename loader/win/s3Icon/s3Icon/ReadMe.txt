========================================================================
    ACTIVE TEMPLATE LIBRARY : s3Icon Project Overview
========================================================================

AppWizard has created this s3Icon project for you to use as the starting point for
...
s3Icon.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (s3Icon.h)
        GUID definitions                                (s3Icon_i.c)
        A type library                                  (s3Icon.tlb)
        Marshaling code                                 (s3Icon_p.c and dlldata.c)

s3Icon.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in s3Icon.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named s3Icon.pch and a precompiled types file named StdAfx.obj.
...
s3Iconps.vcxproj
	...
	dlldata.c, s3Icon_i.c and s3Icon_p.c which are required
	to build the proxy/stub DLL.

s3Iconps.vcxproj.filters
