========================================================================
    ACTIVE TEMPLATE LIBRARY : s3Icon1 Project Overview
========================================================================

AppWizard has created this s3Icon1 project for you to use as the starting point for
...
s3Icon1.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (s3Icon1.h)
        GUID definitions                                (s3Icon1_i.c)
        A type library                                  (s3Icon1.tlb)
        Marshaling code                                 (s3Icon1_p.c and dlldata.c)

s3Icon1.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in s3Icon1.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named s3Icon1.pch and a precompiled types file named StdAfx.obj.
...
s3Icon1ps.vcxproj
	...
	dlldata.c, s3Icon1_i.c and s3Icon1_p.c which are required
	to build the proxy/stub DLL.

s3Icon1ps.vcxproj.filters
