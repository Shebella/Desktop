...
public class VersionRange {
	...
	private static Restriction parseRestriction(String spec) throws InvalidVersionSpecificationException {
		...
		if (index < 0) {
			if (!lowerBoundInclusive || !upperBoundInclusive) {
				throw new InvalidVersionSpecificationException("Single version must be surrounded by []: "
						+ spec);
			}
			...
			if (lowerBound.equals(upperBound)) {
				throw new InvalidVersionSpecificationException("Range cannot have identical boundaries: "
						+ spec);
			}
			...
			restriction = new Restriction(lowerVersion, lowerBoundInclusive, upperVersion,
					upperBoundInclusive);
		}
	...
	public boolean equals(Object obj) {
		...
		boolean equals = recommendedVersion == other.recommendedVersion
				|| ((recommendedVersion != null) && recommendedVersion.equals(other.recommendedVersion));
		equals &= restrictions == other.restrictions
